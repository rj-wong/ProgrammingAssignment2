...
## Creates a list containing a function to set and get the matrix, and set and get the inverse matrix
...
## computation. Otherwise, it calculates the inverse and sets the inverse in 
